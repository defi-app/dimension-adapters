...
const fetch = async () => {
    ...
    // Total of just the premium paid back when flash loan borrowing, does not included amount borrowed
    ...
    /*
        ...
        total_gas_fees (total value of gas fees paid to the hedera network)
    */
